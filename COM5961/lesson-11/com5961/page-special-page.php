...
<?php if (have_posts()) :
 while (have_posts()) :
        the_post(); ?>
        <div class="p-6 col-lg-5 p-0">
        <div class="embed-responsive embed-responsive-4by3"><img class="embed-responsive-item" src=<?php the_post_thumbnail(); ?></div>
        </div>
        <div class="p-6 col-lg-7 d-flex flex-column justify-content-center">
